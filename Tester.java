...
/**
 * @author Mark Floryan, updated by Briana Morrison
 * @version 1.1
...
public class Tester {
	...
	public static void main(String[] args) {
		...
		/** ---------------------------------- **/
		/** SOME BASIC TESTS BEFORE STRESS TESTS **/
		/** ---------------------------------- **/
		...
		// add one value
		testList.insertAtHead("alpha");
		testList.insertAtHead("beta");
		System.out.println("should be [beta, alpha]:  " + testList);
		testList.insertAtTail("gamma");
		testList.insertAtTail("delta");
		System.out.println("should be [beta, alpha, gamma, delta]:  " + testList);
		testList.insertAt(1, "epsilon");
		testList.insertAt(4, "zeta");
		System.out.println("should be [beta, epsilon, alpha, gamma, zeta, delta]:  " + testList);
		System.out.println("should be 6:  " + testList.size());
		String one = testList.removeAtHead();
		System.out.println("should be beta:  removed " + one);
		String two = testList.removeAtHead();
		System.out.println("should be epsilon:  removed " + two);
		System.out.println("should be [alpha, gamma, zeta, delta]:  " + testList);
		one = testList.removeAtTail();
		System.out.println("should be delta:  removed " + one);
		two = testList.removeAtTail();
		System.out.println("should be zeta:  removed " + two);
		System.out.println("should be [alpha, gamma]:  " + testList);

		/** ---------------------------------- **/
		/** CHECKING THE LINKED LIST **/
		/** ---------------------------------- **/
		System.out.println("\nNow starting the stress tests...");
